...
def prompt_conflict_resolution() -> ConflictStrategy:
    ...
    console.print("  [cyan]b[/cyan] - Backup existing files and overwrite (recommended)")
    console.print("  [cyan]m[/cyan] - Merge (keep user customizations where possible)")
    ...
    while True:
        ...
        if choice == "b":
            ...
            console.print("[red]Invalid choice. Please enter b, m, s, or a.[/red]")
