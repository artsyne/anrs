...
- **显式状态 (`state.json`)** — 替代脆弱的对话历史。AI 始终先读取此文件以了解"我在执行什么任务"以及"进行到哪一步"。
- **定义的技能 (`skills/`)** — 替代开放式猜测。AI 被限制在已记录的清单中，防止未定义的行为。
...
查看 [适配器文档](cli/data/adapters/README.md) 了解手动设置和模式切换。
